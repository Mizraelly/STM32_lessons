...
#define GPIOC_MODE_REG		(uint32*)	0x40020800
//#define GPIOB_BSRR 			(uint32*) 	0x40020418
...
#define RCC_AHB1_GPIOC_CLOCK	2 //номер біту для ініц.тактування порта C

//reg output and input
//#define GPIOA_IN_DATA_REG 	(uint32*)	0x40020010  //input register A
#define GPIOC_IN_DATA_REG 	(uint32*)	0x40020810  //input register C
